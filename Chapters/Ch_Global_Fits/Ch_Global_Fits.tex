...
The charge density is expected to have a derivative of zero at a $r=0$ \cite{Article:SOG}. This is not accounted for in Equation \ref{eq:sog_rho_no_tail}. To resolve this issue a tail can be added to each Gaussian that represents the Gaussian's behavior at $r<0$. This modified definition of the charge density is given in Equation \ref{eq:sog_rho} \cite{Article:SOG}.
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=1.\linewidth]{Gaussians_Rho.png}
\end{center}
...
%\textbf{$N_{Gaus}$} & \textbf{Avg. $\chi^2$} & \textbf{$\chi^2_r$} & \textbf{BIC} & \textbf{AIC} & \textbf{$\sum$Q$_{i_{ch}}$} & \textbf{$\sum$Q$_{i_{m}}$} & \textbf{$\chi^2_{max}$} & \makecell{\textbf{`Good'}\\ \textbf{Fits}} \\
%\hline
...
%\hline
%\end{tabular}
%\caption{\bf{Determination of $N_{Gaus}$ for $^3$He}}
%\label{tab:3he_ngaus}
%\end{table}
...
%\hline
%\end{tabular}
%\caption{\bf{Determination of $N_{Gaus}$ for $^3$H}}
%\label{tab:3h_ngaus}
%\end{table}
...
%\hline
%%\makecell{\textbf{Absorption}\\ \textbf{Spectrum Shape}} & \textbf{Paint QE} & \makecell{\textbf{Visual}\\ \textbf{Opacity}} \\
%\textbf{$N_{Gaus}$} & \textbf{Avg. $\chi^2$} & \textbf{$\chi^2_r$} & \textbf{BIC} & \textbf{AIC} & \textbf{$\sum$Q$_{i_{ch}}$} & \textbf{$\sum$Q$_{i_{m}}$} & \textbf{$\chi^2_{max}$} & \makecell{\textbf{Below}\\ \textbf{Cut}} \\
%\hline
...
%\hline
%%\makecell{\textbf{Absorption}\\ \textbf{Spectrum Shape}} & \textbf{Paint QE} & \makecell{\textbf{Visual}\\ \textbf{Opacity}} \\
%\textbf{$N_{Gaus}$} & \textbf{Avg. $\chi^2$} & \textbf{$\chi^2_r$} & \textbf{BIC} & \textbf{AIC} & \textbf{$\sum$Q$_{i_{ch}}$} & \textbf{$\sum$Q$_{i_{m}}$}\\
%\hline
...
\begin{subfigure}{1.\textwidth}
  \centering
  \includegraphics[width=1.\linewidth]{3He_Fch_Rep_Data.png}
  \caption{\bf{$^3$He Representative Charge Form Factor with World Data and Amroun Fit}}
  \label{fig:3he_fch_rep_data}
\end{subfigure}\\
\begin{subfigure}{1.\textwidth}
  \centering
  \includegraphics[width=1.\linewidth]{3He_Fm_Rep_Data.png}
...
\begin{figure}[!ht]
	\begin{center}
	\includegraphics[width=1.0\linewidth]{3He_World_Data_Distribution.png}
	\end{center}
...
\begin{subfigure}{1.\textwidth}
  \centering
  \includegraphics[width=1.\linewidth]{3He_Cross_Section.png}
  \caption{\bf{Log Plot Zoomed Out.}}
  \label{fig:3he_cross_section_no_zoom}
\end{subfigure}\\
\begin{subfigure}{1.\textwidth}
  \centering
  \includegraphics[width=1.\linewidth]{3He_Cross_Section_Zoom.png}
...
%\begin{figure}[!ht]
%\begin{center}
%\includegraphics[width=1.0\linewidth]{3He_Cross_Section.png}
%\end{center}
%\caption[$^3$He Elastic Cross Section]{
%{\bf{$^3$He Elastic Cross Section.}} Plot of the $^3$He elastic cross section using the kinematics of experiment E08-014. The red line represents the new $^3$He cross section fit using the new representative form factor fits from this work, and the blue line is the cross section built from the previous form factor fits found in \cite{Article:Amroun}. The black dot represents the new $^3$He cross section measurement from this analysis.}
%\label{fig:3he_cross_section}
%\end{figure}
...
\begin{subfigure}{1.\textwidth}
  \centering
  \includegraphics[width=1.\linewidth]{3H_Fch_Rep_Data.png}
  \caption{\bf{$^3$H Representative Charge Form Factor with World Data and Amroun Fit}}
  \label{fig:3h_fch_rep_data}
\end{subfigure}\\
\begin{subfigure}{1.\textwidth}
  \centering
  \includegraphics[width=1.\linewidth]{3H_Fm_Rep_Data.png}
...
\begin{figure}[!ht]
	\begin{center}
	\includegraphics[width=1.0\linewidth]{3H_World_Data_Distribution.png}
	\end{center}
...
%	\end{center}
%	\caption[$^3$H Representative Form Factors and World Data Distribution]{
%	{\bf{$^3$H Representative Form Factors and World Data Distribution.}} The top two plots show the $^3$H $F_{ch}$ and $F_m$ versus $Q^2$, and the lowest plot shows the $^3$H world data distribution in $Q^2$ used in this analysis.}
%	\label{fig:3h_data_distribution}
%\end{figure}
...
\begin{figure}[!ht]
	\begin{center}
	\includegraphics[width=1.0\linewidth]{3H_Rep_Chi2_vs_Q2.png}
	\end{center}
...
\begin{figure}[!ht]
	\begin{center}
	\includegraphics[width=1.1\linewidth]{Fch_3He_n12_852_Errors_Rep.png}
	\end{center}
...
\begin{figure}[!ht]
	\begin{center}
	\includegraphics[width=1.1\linewidth]{Fm_3He_n12_852_Errors_Rep.png}
	\end{center}
...
\begin{figure}[!ht]
	\begin{center}
	\includegraphics[width=1.0\linewidth]{3He_Fch_Rep_Data_Zoom.png}
	\end{center}
...
\begin{figure}[!ht]
	\begin{center}
	\includegraphics[width=1.1\linewidth]{Fch_3H_n8_908_Errors_Rep.png}
	\end{center}
...
\begin{figure}[!ht]
	\begin{center}
	\includegraphics[width=1.1\linewidth]{Fm_3H_n8_908_Errors_Rep.png}
	\end{center}
...
\begin{figure}[!ht]
	\begin{center}
	\includegraphics[width=1.0\linewidth]{3H_Fch_Rep_Data_Zoom.png}
	\end{center}
...
\subsection{$^3$He and $^3$H Comparison}
...
\begin{figure}[!ht]
	\begin{center}
	\includegraphics[width=1.0\linewidth]{Fch_Comparison.png}
	\end{center}
...
\begin{figure}[!ht]
	\begin{center}
	\includegraphics[width=1.0\linewidth]{Charge_Density_Comparison.png}
	\end{center}
...
The $^3$He plateau region near $Q^2$ = 0 is wider than the corresponding plateau in $^3$H indicating that there is a larger region of near constant charge density at the center of the $^3$He nucleus than the $^3$H nucleus. (However, there is more uncertainty on the $^3$H charge density near $Q^2$ = 0 as seen in Figure \ref{fig:3h_charge_density_cut} which means a range of plateau shapes are possible for $^3$H). While it is clear that the different Coulomb forces in the two nuclei cause some differences, the total shapes of the form factors and charge densities are quite similar due to the mirror nuclei having the same ground state shell-model states. 