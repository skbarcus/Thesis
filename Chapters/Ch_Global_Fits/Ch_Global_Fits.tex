...
\end{subfigure}
\caption[$^3$He Charge Densities]{\bf{$^3$He Charge Densities.}}
...
\begin{subfigure}{1.\textwidth}
  ...
  \label{fig:3he_qm}
\end{subfigure}
\caption[$^3$He Q$_i$ Fit Parameters]{\bf{$^3$He Q$_i$ Fit Parameters.}}
\label{fig:3he_qi}
\end{figure}
...
\hline
\end{tabular}
\caption[Parameters for $^3$He World Data Representative Fit]{\bf{Parameters for $^3$He World Data Representative Fit}}
...
\end{subfigure}
\caption[$^3$H Charge Densities]{\bf{$^3$H Charge Densities.}}
...
\begin{subfigure}{1.\textwidth}
  ...
  \label{fig:3h_qm}
\end{subfigure}
\caption[$^3$H Q$_i$ Fit Parameters]{\bf{$^3$H Q$_i$ Fit Parameters.}}
\label{fig:3h_qi}
\end{figure}
...
\hline
\end{tabular}
\caption[Parameters for $^3$H World Data Representative Fit]{\bf{Parameters for $^3$H World Data Representative Fit}}
...
\begin{figure}[!ht]
	...
	\end{center}
	\caption[$^3$He F$_{ch}$ Comparison of Results]{
...
\begin{figure}[!ht]
	...
	\end{center}
	\caption[$^3$He F$_{m}$ Comparison of Results]{
...
\begin{figure}[!ht]
	...
	\end{center}
	\caption[$^3$H F$_{ch}$ Comparison of Results]{
...
\begin{figure}[!ht]
	...
	\end{center}
	\caption[$^3$H F$_{m}$ Comparison of Results]{
