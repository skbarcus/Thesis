...
Now let's examine the fits from ~\ref{tab:3he_fits} visually. Figure ~\ref{fig:3he_fch_no_cut} shows the results of each of the 1352 fits of the $^3$He world data without any $\chi^2_{max}$ cut plotted together. 
