...
{\bf{Charge Form Factors from 1352 $^3$He Fits}} These charge form factors were derived from 1352 fits of the $^3$He world data using the pseudorandom R$_i$ values and the R$_i$ optimization procedure. No $\chi^2_{max}$ cut was applied resulting in many nonphysical fits.}
...
{\bf{Charge Form Factors from 1352 $^3$He Fits $\chi^2_{max}$ = 500}} These charge form factors were derived from 1352 fits of the $^3$He world data using the pseudorandom R$_i$ values and the R$_i$ optimization procedure. A $\chi^2_{max}$ = 500 cut was applied removing the nonphysical fits leaving 852 `good' fits.}
\label{fig:3he_fch_cut}
\end{figure}

Figure ~\ref{fig:3he_fm_no_cut} shows the resulting magnetic form factors of each of the 1352 fits of the $^3$He world data without any $\chi^2_{max}$ cut plotted together.
...
{\bf{Magnetic Form Factors from 1352 $^3$He Fits}} These magnetic form factors were derived from 1352 fits of the $^3$He world data using the pseudorandom R$_i$ values and the R$_i$ optimization procedure. No $\chi^2_{max}$ cut was applied resulting in many nonphysical fits.}
...
{\bf{Magnetic Form Factors from 1352 $^3$He Fits $\chi^2_{max}$ = 500}} These magnetic form factors were derived from 1352 fits of the $^3$He world data using the pseudorandom R$_i$ values and the R$_i$ optimization procedure. A $\chi^2_{max}$ = 500 cut was applied removing the nonphysical fits leaving 852 `good' fits.}
