...
{\bf{$Y_{target}$ Acceptance.}} The red acceptance region runs from -0.03 m to 0.028 m. The bump starting around 0.01 m is due to the increased target density due to the boiling effects discussed in Section \ref{sec:density}.}
...
{\bf{SIMC $\phi$ and Experimental Data $\phi$.}} The red histogram is the SIMC data and the blue histogram is the experimental data.}
\label{fig:simc_phi}
\end{figure}
...
{\bf{SIMC $\theta$ and Experimental Data $\theta$.}} The red histogram is the SIMC data and the blue histogram is the experimental data.}
...
{\bf{SIMC $dP$ and Experimental Data $dP$.}} The red histogram is the SIMC data and the blue histogram is the experimental data.}
\label{fig:simc_dp}
\end{figure}
...
{\bf{Solid Angle Acceptance of $^3$He Cell in $Y_{target}$}} The top left plot shows the electron events distributed in $Y_{target}$. The second from the top left shows the solid angle acceptance for all of $Y_{target}$. The remaining plots show the solid angle acceptance at different slices of $Y_{target}$ every centimeter.}
