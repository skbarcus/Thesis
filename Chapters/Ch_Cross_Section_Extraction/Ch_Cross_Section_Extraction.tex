...
{\bf{$^3$He Elastic Cross Section at 3.356 GeV}} This cross section was produced using a representative sit from the sum of Gaussians fits discussed in Section *** ~\ref{sec:sog}}
\label{fig:xs_bin}
\end{figure}
