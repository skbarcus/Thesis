...
\hline
3892 & 0.9692\\%0.969217
3893 & 0.9885\\%0.988504
3894 & 0.9894\\%0.989435
4073 & 0.9888\\%0.988796
4074 & 0.9890\\%0.989009
4075 & 0.9887\\%0.988678  
\hline
\makecell{\textbf{Weighted}\\ \textbf{Average}} & \textbf{0.9886} \\%0.988577
\hline
\end{tabular}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=1.\linewidth]{PID_GC_Ye.png}
\end{center}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=1.\linewidth]{GC_Eff.png}
\end{center}
...
Plugging in the corresponding values from the experimental setup and the simulation we can rewrite the product in Equation \ref{eq:fractional_density} as Equation \ref{eq:r1}.
...
%Crap... Figure \ref{fig:simc_dp} shows the SIMC result for $dP$ in red, and the blue shows the experimental data. Here we see the correct shape, but the SIMC data seems to be shifted a bit. This is probably the result of the optics calibration, and is a known issue with SIMC currently. Past analyses have found that this small offset in $dP$ does not substantially influence the cross section results \cite{dien}. In Section \ref{sec:comparisons} it will be shown that this analysis' cross section result agrees with similar measurements and predictions from other form factor fits.
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=1.03\linewidth]{Solid_Angle_Ytarget.png}
\end{center}
