...
To extract the final $^3$He elastic cross section value for this analysis a physics simulation Monte Carlo program called SIMC was used. SIMC produces events randomly in a given energy, angle, and momentum acceptance range in the detector and then tracks these events back through the spectrometer to their reaction vertex in the target.